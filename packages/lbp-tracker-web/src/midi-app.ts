 ...
 *
 * The conversion itself is `packages/lbp-tracker-lib/src/midi.ts`, which is where the interesting
 ...
 * second one here: `packages/lbp-tracker-web/src/live.ts` already has the transport, the effects, the
 ...
 * `packages/cwlib-ts/src/backup.ts`.
 */
