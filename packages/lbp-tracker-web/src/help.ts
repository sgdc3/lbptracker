  ...
  notes: {
    ...
    body:
      ...
      p('<strong>grid</strong> is how long the instrument is, in bars. <strong>key</strong> and <strong>scale</strong> ' +
        ...
        '<strong>Loop this chip</strong> pauses the song at the chip\'s start; play then goes round its bars with ' +
        'every other row at a fifth of its volume, to hear the part in place while you edit it. It follows the ' +
        'chip you select; pressing it again plays the song on from the chip\'s start, and stop, or closing the ' +
        'panel, ends it too. Drag the panel\'s top edge to resize it; <kbd>Esc</kbd> closes it.'),
  },
  song: {
    title: 'The song',
    body:
