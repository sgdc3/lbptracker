...
import { boardCell } from '../src/level.ts';
import { boardToGrid } from '../src/project.ts';
...
/**
 * ⚠️ The case `packages/cwlib-ts/dev/board-probe.ts` measures: one of the corpus's seven open
