...
**Nothing here blocks any more.** `SampleGuids` -> audio, the last blocking unknown, was resolved
...
## 2. Grid resolution, swing, and triplets
...
## 6. FMOD's resampler quality and pan law — **now audible, not cosmetic**
...
## 7. Semantics of the remaining fields
