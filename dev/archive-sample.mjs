 ...
 *
 *     node dev/archive-sample.mjs [count] [dir]
 *
 ...
 * command. Every real bug in `src/core/parts.ts` found since 2026-09-05 came out
 ...
 * `rootLevelUrl` from `dev/lbparchive.ts`, restated here because this is a Node
...
/** Where a root level's bytes are. See `rootLevelUrl` in `dev/lbparchive.ts`. */
...
console.log(`now: node --experimental-strip-types dev/walk-levels.ts ${DIR}`);
