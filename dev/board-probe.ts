 ...
 *
 *   node --experimental-strip-types dev/board-probe.ts [dir]
 *
 * `boardCell` in `src/core/level.ts` exists because an **open** circuit board
...
import { boardCell, readLevel } from '../src/core/level.ts';
import { partReaders, type Microchip } from '../src/core/parts.ts';
